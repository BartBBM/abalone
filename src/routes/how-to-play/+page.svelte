...
<section class="mx-auto max-w-prose text-lg">
	<h1 class="mb-4 text-center text-2xl font-medium text-fuchsia-600">How to play abalone</h1>
	<p>
		If you're not familiar with the rules, I'd recommend taking a moment
